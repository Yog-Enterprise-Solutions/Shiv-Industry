...
var supplier = null
frappe.query_reports["Supplier Quotation Compare"] = {
	filters: [
		{
			fieldtype: "Link",
			label: __("Company"),
    ...
    formatter: (value,row,column,data,default_formatter) => {
        value = default_formatter(value, row, column, data);
        console.log(column)
	// ["price", "supplier_name", "item_code"].includes(column.fieldname)
        if (data.flag && column.fieldname == "price" ){
	    console.log(column.fieldname);
            value = "<span style='color:green'>" + value + "</span>";
        }
		else if (data.flag && column.fieldname == "supplier_name"){
			console.log(column.fieldname)
			value = "<span style='background-color:green'>" + value + "</span>";
		}
		else if(data.flag && column.fieldname == "item_code"){
			console.log(column.fieldname);
			value = "<span style='background-color:green'>" + value + "</span>";
		}
